...
function formatDate(value: string) {
  return new Date(value.replace(" ", "T") + (value.includes("Z") ? "" : "Z")).toLocaleString("zh-CN", { hour12: false });
}
